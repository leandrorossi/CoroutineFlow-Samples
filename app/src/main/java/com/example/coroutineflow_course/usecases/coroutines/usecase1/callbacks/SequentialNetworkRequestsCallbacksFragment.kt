...
import com.example.coroutineflow_course.databinding.FragmentSequencialNetworkRequestsCallbacksBinding
...
class SequentialNetworkRequestsCallbacksFragment : Fragment() {
    ...
    private var _binding: FragmentSequencialNetworkRequestsCallbacksBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding =
            FragmentSequencialNetworkRequestsCallbacksBinding.inflate(inflater, container, false)
        return binding.root
